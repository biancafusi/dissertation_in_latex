...
,INPECopyright	% as opções de licença são: CCBY, CCBYSA, CCBYND, CCBYNC, CCBYNCSA, CCBYNCND, GPLv3 e INPECopyright
]{./template/tdiinpe}
...
\definecolor{azulClaro}{RGB}{102,153,255}
\definecolor{verdeEscuro}{RGB}{0,100,0}
\definecolor{roxo}{RGB}{153,0,204}
\definecolor{cinzaClaro}{RGB}{200,200,200}
\definecolor{verdeClaro}{RGB}{0,200,120}
\definecolor{amarelo}{RGB}{255,204,0}
\definecolor{pretoFundo}{RGB}{15,15,15}

\lstset{
	language=Python,
	backgroundcolor=\color{pretoFundo},
	basicstyle=\ttfamily\footnotesize\color{white},
	keywordstyle=\color{roxo},
	commentstyle=\color{verdeEscuro},
	stringstyle=\color{cinzaClaro},
	identifierstyle=\color{azulClaro},
	emph={append,isel,range,len,print}, % funções destacadas
	emphstyle=\color{verdeClaro},
	frame=single,
	rulecolor=\color{pretoFundo},
	numbers=left,
	numberstyle=\tiny\color{gray},
	breaklines=true,
	tabsize=4,
	showstringspaces=false,
	literate={[}{{\color{amarelo}[}}1
	{]}{{\color{amarelo}]}}1
}
...
\include{./docs/08_031_capitulo3}
\include{./docs/08_032_capitulo4} %% 4o capítulo
\include{./docs/08_03_capitulo5} %% DATA
\include{./docs/08_04_capitulo6}
\include{./docs/08_04_capitulo7}  
...
\include{./docs/10_01_apendiceA}
\include{./docs/10_01_apendiceB}
\include{./docs/10_01_apendiceC}
\include{./docs/10_01_apendiceD}
\include{./docs/10_01_apendiceE}
\include{./docs/10_01_apendiceF} %% insira
\include{./docs/10_01_apendiceG} %%apendices tal qual capítulos acima
