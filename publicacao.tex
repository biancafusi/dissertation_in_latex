...
\include{./docs/08_031_capitulo31} %% DATA
\include{./docs/08_032_capitulo32} %% METHODS
\include{./docs/08_03_capitulo3}
\include{./docs/08_04_capitulo4} %% 4o capítulo
\include{./docs/08_04_capitulo5} %% 5o capítulo
\include{./docs/08_04_capitulo6} 
\include{./docs/09_01_appendixA}
