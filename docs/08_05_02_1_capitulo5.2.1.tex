...
At first glance, the reader will notice the observed congruence between the ERA5 reanalysis data and the best track observations. This strong agreement may be attributable to the reanalysis nature \cite{dulac2024assessing}, which integrates observational datasets throughout the integration period, thereby leading to this expected behaviour.
...
\begin{figure}[!ht]
	...
	\vspace{2mm}
	Source: This image was generated at this website at \url{https://www.emc.ncep.noaa.gov/HAFS/HAFSEPS/index.php}, 2025 . % Fonte abaixo da imagem
