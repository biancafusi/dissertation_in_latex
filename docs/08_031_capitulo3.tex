...
In the literature review, comparisons can be found between this type of dataset and others, such as satellite data and ERA5 products, particularly concerning landfalling tropical cyclones in the USA. For example, \citeonline{mazza2023tropical} offer an overview of these datasets within the context of tropical cyclone climatology and conclude that NCEP/EMC Stage IV (hereafter referred to simply as NCEP) identifies significantly higher precipitation rates in landfalling tropical cyclones than the other datasets.
