...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{
			...
			Initial Condition 
			& Compares the effect of two initial conditions, June 29, July 2nd (noon), and July 3rd 
